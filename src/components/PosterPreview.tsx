        ...
        >
          ...
          <div className="absolute inset-0 flex flex-col items-center p-12 text-white">
            ...
            <div className="flex flex-col items-center text-center flex-grow w-full">
              <h1 className="font-bold mb-2" style={{ fontSize: `${TITLE_SIZE}rem` }}>
                CUBE OF TRUTH
              </h1>
              ...
              <div className="space-y-6 mb-12">
                <div className="flex flex-col">
                  <div style={{ fontSize: `${TEXT_SIZE}rem` }}>{englishDate}</div>
                  <div className="h-5">
                    <div
              ...
              <div className="mb-18" style={{ fontSize: `${TEXT_SIZE}rem` }}>
                {location}
              </div>
            </div>
